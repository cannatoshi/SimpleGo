...
The authors shall not be liable for any damages resulting from the use or inability to use the software.

### Intended Use

This software is designed for:
- Personal privacy-focused communication
- Educational and research purposes
- Testing on your own hardware
...
Die Autoren haften nicht fuer Schaeden aus der Nutzung der Software.

### Bestimmungsgemaesse Verwendung

- Persoenliche datenschutzorientierte Kommunikation
- Bildungs- und Forschungszwecke
- Tests auf eigener Hardware
