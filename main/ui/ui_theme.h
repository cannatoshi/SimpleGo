...
/* New v2 colors */
#define UI_COLOR_STATUS_BG    lv_color_hex(0x000508)
#define UI_COLOR_HDR_BG       lv_color_hex(0x000a10)
#define UI_COLOR_ENCRYPT      lv_color_hex(0x2a9d5c)  /* Muted green */
#define UI_COLOR_INPUT_BG     lv_color_hex(0x000d14)

/* Layout - legacy (used by other screens) */
...
/* Layout - v2 status bar */
#define UI_STATUS_H           16

#define UI_FONT               &lv_font_montserrat_14

/* Legacy widget helpers (used by contacts, settings, developer, etc.) */
...
/**
 * @brief Create status bar with GO menu button, time, WiFi, battery
 * @param parent  Screen object
 * @return GO button object (caller attaches click handler)
 *
 * Creates: 16px status bar at y=0, 1px cyan glow line at y=16.
 * All indicators are placeholders for now.
 */
